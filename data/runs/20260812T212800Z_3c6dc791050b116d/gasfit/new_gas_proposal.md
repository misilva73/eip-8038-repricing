...
_Generated 2026-08-13 08:00:07Z · fork `osaka` · anchor_rate 100 Mgas/s_
...
| --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | 2100 | 2296 | +196 | +9% |
| COLD_STORAGE_WRITE | 5000 | 16726 | +11726 | +235% |
| WARM_ACCESS | 100 | 38 | -62 | -62% |
| COLD_ACCOUNT_NOCODE_ACCESS | 2600 | 2235 | -365 | -14% |
...
| STORAGE_WRITE | 2800 | 14430 | +11630 | +415% |
| ACCOUNT_WRITE | 6700 | 26725 | +20025 | +299% |
| REFUND_STORAGE_CLEAR | 4800 | 16057 | +11257 | +235% |
| TX_ACCESS_LIST_STORAGE_KEY | 1900 | 2296 | +396 | +21% |
...
| --- | --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | geth | 2296 | besu | 1522 | 1.51× |
| COLD_STORAGE_WRITE | erigon | 16726 | geth | 14125 | 1.18× |
| WARM_ACCESS | nethermind | 38 | geth | 18 | 2.11× |
| COLD_ACCOUNT_NOCODE_ACCESS | geth | 2235 | besu | 1796 | 1.24× |
| COLD_ACCOUNT_NOCODE_WRITE | erigon | 28960 | besu | 14949 | 1.94× |
| COLD_ACCOUNT_CODE_ACCESS | erigon | 13733 | besu | 2250 | 6.10× |
| COLD_ACCOUNT_CODE_WRITE | erigon | 15959 | besu | 7212 | 2.21× |
...
<details>
<summary><b>Priced glue opcodes with a poor fit</b> — 136 (glue_opcode, client) fits skipped</summary>
...
| `CALLDATALOAD` | `erigon` (R²), `ethrex` (R²), `geth` (R²), `nethermind` (R²), `reth` (both) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_CODE_WRITE`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_ACCOUNT_NOCODE_WRITE`, `COLD_STORAGE_ACCESS`, `COLD_STORAGE_WRITE` |
| `CALLDATASIZE` | `besu` (p-value), `erigon` (R²), `ethrex` (R²), `geth` (R²), `reth` (R²) | — |
...
| `PC` | `ethrex` (R²), `geth` (R²), `nethermind` (R²), `reth` (R²) | `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_ACCOUNT_NOCODE_WRITE`, `COLD_STORAGE_ACCESS` |
...
| `PUSH0` | `besu` (p-value), `erigon` (both), `ethrex` (both), `geth` (both), `reth` (R²) | — |
| `RETURNDATASIZE` | `erigon` (R²), `ethrex` (R²), `geth` (R²), `nethermind` (R²), `reth` (R²) | — |
