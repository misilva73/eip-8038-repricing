...
_Generated 2026-06-30 11:43:00Z · fork `osaka` · anchor_rate 100 Mgas/s_
...
| --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | 2100 | 2405 | +305 | +15% |
| COLD_STORAGE_WRITE | 5000 | 28727 | +23727 | +475% |
| COLD_ACCOUNT_NOCODE_ACCESS | 2600 | 2262 | -338 | -13% |
| COLD_ACCOUNT_CODE_ACCESS | 2600 | 4947 | +2347 | +90% |
| COLD_ACCOUNT_NOCODE_WRITE | 9300 | 26526 | +17226 | +185% |
| COLD_ACCOUNT_CODE_WRITE | 9300 | 27469 | +18169 | +195% |
| WARM_ACCESS | 100 | 63 | -37 | -37% |
| STORAGE_WRITE | 2800 | 26322 | +23522 | +840% |
| ACCOUNT_WRITE | 6700 | 24264 | +17564 | +262% |
| REFUND_STORAGE_CLEAR | 4800 | 27578 | +22778 | +475% |
| TX_ACCESS_LIST_STORAGE_KEY | 1900 | 2405 | +505 | +27% |
...
| --- | --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | geth | 2405 | besu | 1520 | 1.58× |
| COLD_STORAGE_WRITE | erigon | 28727 | geth | 13540 | 2.12× |
| COLD_ACCOUNT_NOCODE_ACCESS | geth | 2262 | besu | 1594 | 1.42× |
| COLD_ACCOUNT_CODE_ACCESS | erigon | 4947 | besu | 2653 | 1.86× |
| COLD_ACCOUNT_NOCODE_WRITE | erigon | 26526 | besu | 17665 | 1.50× |
| COLD_ACCOUNT_CODE_WRITE | erigon | 27469 | besu | 17665 | 1.55× |
| WARM_ACCESS | besu | 63 | erigon | 49 | 1.29× |
...
| `JUMPI` | `reth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_CODE_WRITE`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_ACCOUNT_NOCODE_WRITE`, `COLD_STORAGE_ACCESS`, `COLD_STORAGE_WRITE` |
...
| --- | --- | --- | --- | --- |
| `test_sstore_bloated` | `SSTORE` | `target_coef` | — | `ethrex` (R²) |
