...
_Generated 2026-06-01 11:52:36Z · fork `osaka` · anchor_rate 100 Mgas/s_
...
| --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | 2100 | 2755 | +655 | +31% |
| STORAGE_WRITE | 2800 | 212839 | +210039 | +7501% |
| COLD_ACCOUNT_NOCODE_ACCESS | 2600 | 10350 | +7750 | +298% |
| ACCOUNT_WRITE | 6700 | 202822 | +196122 | +2927% |
| COLD_ACCOUNT_CODE_ACCESS | 2600 | 10350 | +7750 | +298% |
| WARM_ACCESS | 100 | 135 | +35 | +35% |
| REFUND_STORAGE_CLEAR | 4800 | 206971 | +202171 | +4212% |
| TX_ACCESS_LIST_STORAGE_KEY | 1900 | 2755 | +855 | +45% |
| TX_ACCESS_LIST_ADDRESS | 2400 | 10350 | +7950 | +331% |
...
| --- | --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | nethermind | 2755 | besu | 1568 | 1.76× |
| STORAGE_WRITE | erigon | 212839 | reth | 17126 | 12.43× |
| COLD_ACCOUNT_NOCODE_ACCESS | erigon | 10350 | reth | 3746 | 2.76× |
| ACCOUNT_WRITE | erigon | 202822 | reth | 16411 | 12.36× |
| COLD_ACCOUNT_CODE_ACCESS | erigon | 10350 | reth | 3746 | 2.76× |
| WARM_ACCESS | besu | 135 | nethermind | 72 | 1.88× |
...
| --- | --- | --- |
| `AND` | `reth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
| `CALLDATALOAD` | `besu` (both), `erigon` (R²), `geth` (R²), `nethermind` (R²), `reth` (R²) | — |
| `CALLDATASIZE` | `nethermind` (p-value) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
| `DUP` | `nethermind` (p-value) | `COLD_STORAGE_ACCESS` |
| `EXP` | `nethermind` (both) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
| `GAS` | `nethermind` (p-value) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_STORAGE_ACCESS`, `WARM_ACCESS` |
| `GT` | `nethermind` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `ISZERO` | `erigon` (R²), `nethermind` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
| `JUMPI` | `nethermind` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `KECCAK256` | `besu` (R²), `erigon` (R²), `geth` (R²), `nethermind` (both), `reth` (both) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
| `LT` | `nethermind` (R²) | `COLD_STORAGE_ACCESS` |
| `MSTORE` | `reth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
| `MSTORE8` | `reth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
...
<details>
<summary><code>COLD_ACCOUNT_NOCODE_ACCESS</code> — 3 weak combos</summary>
...
<details>
<summary><code>COLD_ACCOUNT_CODE_ACCESS</code> — 3 weak combos</summary>
