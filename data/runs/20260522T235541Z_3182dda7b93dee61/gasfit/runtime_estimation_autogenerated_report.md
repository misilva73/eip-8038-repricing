...
| client | nobs | R² | target_coef (ms) | p-value | 95% CI |
| --- | --- | --- | --- | --- | --- |
| `erigon` | 66 | 0.9473 | 0 | 1.00e+00 | [0, 0] |
| `geth` | 198 | 0.9481 | 0.04465 | 1.00e-03 | [0.04153, 0.04738] |
| `nethermind` | 132 | 0.9113 | 0.003677 | 1.00e-03 | [0.003462, 0.003874] |
| `reth` | 132 | 0.5859 | 0 | 1.00e+00 | [0, 0.0005496] |
...
No. Observations:       66                                RMSE:         516.47
Df Residuals:           63                                 MAE:         374.76
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    736.9647     58.2910       0.001    632.6615    855.3105
       opcount      0.0000      0.0000       1.000      0.0000      0.0000
        update      2.0565      0.0523       0.001      1.9706      2.1746
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       198                               RMSE:         467.45
Df Residuals:           195                                MAE:         323.12
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    725.0906    105.4916       0.001    529.2853    937.6659
       opcount      0.0446      0.0015       0.001      0.0415      0.0474
        update      0.1709      0.0479       0.001      0.0721      0.2592
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       132                               RMSE:          38.79
Df Residuals:           129                                MAE:          29.46
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    130.1984      9.2382       0.001    113.7775    149.0677
       opcount      0.0037      0.0001       0.001      0.0035      0.0039
        update      0.0672      0.0048       0.001      0.0577      0.0764
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       132                               RMSE:          64.63
Df Residuals:           129                                MAE:          41.08
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    170.6159     18.0986       0.001    115.8172    182.9449
       opcount      0.0000      0.0002       1.000      0.0000      0.0005
        update      0.0722      0.0069       0.001      0.0674      0.0942
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
| client | nobs | R² | target_coef (ms) | p-value | 95% CI |
| --- | --- | --- | --- | --- | --- |
| `erigon` | 66 | 0.9938 | 0 | 1.00e+00 | [0, 0] |
| `geth` | 198 | 0.8891 | 0.03631 | 1.00e-03 | [0.03371, 0.03867] |
| `nethermind` | 132 | 0.7132 | 0.02837 | 1.00e-03 | [0.02539, 0.03173] |
| `reth` | 132 | 0.9954 | 0 | 1.00e+00 | [0, 0] |
...
No. Observations:       66                                RMSE:        1174.16
Df Residuals:           63                                 MAE:         901.07
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    973.1362    127.2897       0.001    752.8892   1252.6940
       opcount      0.0000      0.0000       1.000      0.0000      0.0000
        update      0.6827      0.0075       0.001      0.6701      0.6990
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       198                               RMSE:         433.80
Df Residuals:           195                                MAE:         329.25
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const   1213.1677    110.0107       0.001   1009.9778   1431.7058
       opcount      0.0363      0.0013       0.001      0.0337      0.0387
        update      0.0659      0.0018       0.001      0.0625      0.0694
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       132                               RMSE:         499.59
Df Residuals:           129                                MAE:         402.90
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const   1041.9195    133.8360       0.001    771.2771   1306.6431
       opcount      0.0284      0.0017       0.001      0.0254      0.0317
        update      0.0331      0.0025       0.001      0.0282      0.0379
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       132                               RMSE:         251.88
Df Residuals:           129                                MAE:         187.94
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    255.6025     20.0799       0.001    219.6261    298.8836
       opcount      0.0000      0.0000       1.000      0.0000      0.0000
        update      0.1716      0.0010       0.001      0.1699      0.1738
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
| client | nobs | R² | target_coef (ms) | p-value | 95% CI |
| --- | --- | --- | --- | --- | --- |
| `erigon` | 66 | 0.9778 | 0.002226 | 4.22e-01 | [0, 0.03503] |
| `geth` | 198 | 0.9186 | 0.04709 | 1.00e-03 | [0.0447, 0.0494] |
| `nethermind` | 132 | 0.9229 | 0.02104 | 1.00e-03 | [0.01999, 0.02229] |
| `reth` | 132 | 0.9769 | 0.02993 | 1.00e-03 | [0.02808, 0.03205] |
...
Dep. Variable:          test_runtime_ms              R-squared:          0.978
Model:                  NNLS                    Adj. R-squared:          0.977
No. Observations:       66                                RMSE:        2327.58
Df Residuals:           63                                 MAE:        1828.71
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const   7516.5306    841.9884       0.001   5181.4787   8260.9271
       opcount      0.0022      0.0108       0.422      0.0000      0.0350
        update      1.3928      0.0410       0.001      1.3355      1.4933
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       198                               RMSE:         300.31
Df Residuals:           195                                MAE:         226.37
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    928.2338     66.1710       0.001    800.9540   1058.0846
       opcount      0.0471      0.0012       0.001      0.0447      0.0494
        update      0.0395      0.0024       0.001      0.0351      0.0441
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       132                               RMSE:         119.02
Df Residuals:           129                                MAE:          88.37
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    213.6951     30.2794       0.001    152.3350    273.0426
       opcount      0.0210      0.0006       0.001      0.0200      0.0223
        update      0.0379      0.0012       0.001      0.0355      0.0401
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
Dep. Variable:          test_runtime_ms              R-squared:          0.977
Model:                  NNLS                    Adj. R-squared:          0.977
No. Observations:       132                               RMSE:         179.10
Df Residuals:           129                                MAE:         131.70
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    654.7855     71.5453       0.001    504.3260    784.3286
       opcount      0.0299      0.0010       0.001      0.0281      0.0321
        update      0.1398      0.0022       0.001      0.1359      0.1444
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
| client | nobs | R² | target_coef (ms) | p-value | 95% CI |
| --- | --- | --- | --- | --- | --- |
| `erigon` | 66 | 0.9859 | 0 | 1.00e+00 | [0, 0.001856] |
| `geth` | 198 | 0.8055 | 0.01274 | 1.00e-03 | [0.01182, 0.01375] |
| `nethermind` | 132 | 0.894 | 0.005158 | 1.00e-03 | [0.004497, 0.005734] |
| `reth` | 132 | 0.9916 | 0 | 1.00e+00 | [0, 0] |
...
No. Observations:       66                                RMSE:         404.86
Df Residuals:           63                                 MAE:         329.99
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    992.9779     77.4801       0.001    800.5927   1112.3104
       opcount      0.0000      0.0005       1.000      0.0000      0.0019
        update      0.2900      0.0049       0.001      0.2818      0.3011
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       198                               RMSE:         160.76
Df Residuals:           195                                MAE:         132.19
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    469.1599     34.5642       0.001    400.3724    536.5361
       opcount      0.0127      0.0005       0.001      0.0118      0.0137
        update      0.0378      0.0015       0.001      0.0350      0.0407
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
Dep. Variable:          test_runtime_ms              R-squared:          0.894
Model:                  NNLS                    Adj. R-squared:          0.892
No. Observations:       132                               RMSE:          91.46
Df Residuals:           129                                MAE:          68.01
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    131.3639     21.7533       0.001     91.1583    176.2541
       opcount      0.0052      0.0003       0.001      0.0045      0.0057
        update      0.0305      0.0011       0.001      0.0284      0.0325
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
Model:                  NNLS                    Adj. R-squared:          0.991
No. Observations:       132                               RMSE:         178.80
Df Residuals:           129                                MAE:         104.09
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    152.7426     16.1994       0.001    126.6199    185.6094
       opcount      0.0000      0.0001       1.000      0.0000      0.0000
        update      0.1664      0.0010       0.001      0.1642      0.1684
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
| client | nobs | R² | target_coef (ms) | p-value | 95% CI |
| --- | --- | --- | --- | --- | --- |
| `erigon` | 66 | 0.9067 | 0.005981 | 1.00e-03 | [0.00316, 0.008477] |
| `geth` | 198 | 0.9456 | 0.04749 | 1.00e-03 | [0.04599, 0.04913] |
| `nethermind` | 132 | 0.9386 | 0.00632 | 1.00e-03 | [0.005754, 0.006926] |
| `reth` | 132 | 0.2694 | 0.0005943 | 1.00e-03 | [0.0003779, 0.0008136] |
...
No. Observations:       66                                RMSE:         275.14
Df Residuals:           63                                 MAE:         204.43
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    352.6850    110.2815       0.001    148.8835    598.2957
       opcount      0.0060      0.0013       0.001      0.0032      0.0085
        update      1.8394      0.1261       0.001      1.5945      2.0858
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       198                               RMSE:         463.32
Df Residuals:           195                                MAE:         318.03
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    280.0716     28.0721       0.001    230.9617    337.9161
       opcount      0.0475      0.0008       0.001      0.0460      0.0491
...
No. Observations:       132                               RMSE:          61.82
Df Residuals:           129                                MAE:          28.16
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const     20.0581     11.8459       0.057      0.0000     44.6826
       opcount      0.0063      0.0003       0.001      0.0058      0.0069
        update      0.0328      0.0101       0.001      0.0117      0.0498
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
No. Observations:       132                               RMSE:          22.26
Df Residuals:           129                                MAE:          15.29
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const     62.0343      9.2890       0.001     43.9659     79.4191
       opcount      0.0006      0.0001       0.001      0.0004      0.0008
        update      0.0349      0.0072       0.001      0.0205      0.0483
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
```
...
| client | nobs | R² | target_coef (ms) | p-value | 95% CI |
| --- | --- | --- | --- | --- | --- |
| `erigon` | 66 | 0.9579 | 0.1024 | 1.00e-03 | [0.09831, 0.1071] |
| `geth` | 198 | 0.8836 | 0.04716 | 1.00e-03 | [0.04498, 0.04958] |
| `nethermind` | 132 | 0.9665 | 0.0231 | 1.00e-03 | [0.0221, 0.02415] |
| `reth` | 132 | 0.9009 | 0.03764 | 1.00e-03 | [0.03666, 0.03867] |
...
No. Observations:       66                                RMSE:         572.60
Df Residuals:           63                                 MAE:         398.34
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    318.3476     81.6735       0.001    155.6784    479.9110
       opcount      0.1024      0.0022       0.001      0.0983      0.1071
        update      0.0000      0.0000       1.000      0.0000      0.0000
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
...
No. Observations:       198                               RMSE:         456.88
Df Residuals:           195                                MAE:         334.86
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    594.6527     44.5881       0.001    507.2094    691.3841
       opcount      0.0472      0.0011       0.001      0.0450      0.0496
        update      0.0000      0.0000       1.000      0.0000      0.0000
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
...
No. Observations:       132                               RMSE:         114.78
Df Residuals:           129                                MAE:          83.01
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const     50.8720     16.1269       0.001     17.7687     82.5702
...
Model:                  NNLS                    Adj. R-squared:          0.899
No. Observations:       132                               RMSE:         370.81
Df Residuals:           129                                MAE:         286.70
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const      0.0000      0.0000       1.000      0.0000      0.0000
       opcount      0.0376      0.0005       0.001      0.0367      0.0387
        update      0.0000      0.0000       1.000      0.0000      0.0000
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
...
| client | nobs | R² | target_coef (ms) | p-value | 95% CI |
| --- | --- | --- | --- | --- | --- |
| `erigon` | 66 | 0.9967 | 0.01045 | 1.00e-03 | [0.01038, 0.01051] |
| `geth` | 198 | 0.893 | 0.016 | 1.00e-03 | [0.01529, 0.01676] |
| `nethermind` | 132 | 0.9491 | 0.006764 | 1.00e-03 | [0.006462, 0.007097] |
| `reth` | 132 | 0.9759 | 0.001372 | 1.00e-03 | [0.00134, 0.001411] |
...
No. Observations:       66                                RMSE:          19.38
Df Residuals:           63                                 MAE:          15.43
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const      0.0000      0.1401       1.000      0.0000      0.0000
       opcount      0.0104      0.0000       0.001      0.0104      0.0105
        update      0.0000      0.0000       1.000      0.0000      0.0000
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
...
Model:                  NNLS                    Adj. R-squared:          0.892
No. Observations:       198                               RMSE:         177.54
Df Residuals:           195                                MAE:         150.58
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const    214.3965     20.8751       0.001    172.8856    255.7446
       opcount      0.0160      0.0004       0.001      0.0153      0.0168
        update      0.0000      0.0000       1.000      0.0000      0.0000
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
...
Model:                  NNLS                    Adj. R-squared:          0.948
No. Observations:       132                               RMSE:          50.24
Df Residuals:           129                                MAE:          33.01
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const     27.3578      6.1667       0.003     13.8878     37.5036
       opcount      0.0068      0.0002       0.001      0.0065      0.0071
...
Model:                  NNLS                    Adj. R-squared:          0.976
No. Observations:       132                               RMSE:           6.91
Df Residuals:           129                                MAE:           5.37
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const      9.6978      0.9507       0.001      7.8962     11.5609
...
| client | nobs | R² | target_coef (ms) | p-value | 95% CI |
| --- | --- | --- | --- | --- | --- |
| `erigon` | 66 | 0.9414 | 0.0093 | 1.00e-03 | [0.008991, 0.009481] |
| `geth` | 198 | 0.8675 | 0.05059 | 1.00e-03 | [0.0491, 0.05219] |
| `nethermind` | 132 | 0.9353 | 0.006304 | 1.00e-03 | [0.006083, 0.006521] |
| `reth` | 132 | 0.9109 | 0.001276 | 1.00e-03 | [0.001246, 0.001306] |
...
No. Observations:       66                                RMSE:          86.42
Df Residuals:           63                                 MAE:          69.46
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
...
No. Observations:       198                               RMSE:         678.42
Df Residuals:           195                                MAE:         541.87
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const      0.0000      0.0000       1.000      0.0000      0.0000
       opcount      0.0506      0.0008       0.001      0.0491      0.0522
        update      0.0000      0.0000       1.000      0.0000      0.0000
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
...
No. Observations:       132                               RMSE:          57.42
Df Residuals:           129                                MAE:          44.59
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
         const      0.0000      0.0000       1.000      0.0000      0.0000
       opcount      0.0063      0.0001       0.001      0.0061      0.0065
        update      0.0000      0.0000       1.000      0.0000      0.0000
==============================================================================
Notes: Non-negative least squares with bootstrap inference (1000 iterations)
==============================================================================
...
Dep. Variable:          test_runtime_ms              R-squared:          0.911
Model:                  NNLS                    Adj. R-squared:          0.910
No. Observations:       132                               RMSE:          14.58
Df Residuals:           129                                MAE:          12.63
Df Model:               2      
==============================================================================
                      coef     std err     P-value      [0.025      0.975]
------------------------------------------------------------------------------
