...
_Generated 2026-06-08 11:41:40Z · fork `osaka` · anchor_rate 100 Mgas/s_
...
| --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | 2100 | 2735 | +635 | +30% |
| STORAGE_WRITE | 2800 | 15391 | +12591 | +450% |
| COLD_ACCOUNT_NOCODE_ACCESS | 2600 | 3140 | +540 | +21% |
| ACCOUNT_WRITE | 6700 | 22866 | +16166 | +241% |
| COLD_ACCOUNT_CODE_ACCESS | 2600 | 9131 | +6531 | +251% |
| WARM_ACCESS | 100 | 62 | -38 | -38% |
| REFUND_STORAGE_CLEAR | 4800 | 17401 | +12601 | +263% |
| TX_ACCESS_LIST_STORAGE_KEY | 1900 | 2735 | +835 | +44% |
| TX_ACCESS_LIST_ADDRESS | 2400 | 9131 | +6731 | +280% |
...
| --- | --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | geth | 2735 | nethermind | 1692 | 1.62× |
| STORAGE_WRITE | reth | 15391 | erigon | 13948 | 1.10× |
| COLD_ACCOUNT_NOCODE_ACCESS | geth | 3140 | besu | 2162 | 1.45× |
| ACCOUNT_WRITE | erigon | 22866 | reth | 9047 | 2.53× |
| COLD_ACCOUNT_CODE_ACCESS | erigon | 9131 | besu | 3484 | 2.62× |
| WARM_ACCESS | besu | 62 | erigon | 56 | 1.11× |
...
<details>
<summary><b>Priced glue opcodes with a poor fit</b> — 24 (glue_opcode, client) fits skipped</summary>
...
| --- | --- | --- |
| `AND` | `besu` (R²) | `COLD_ACCOUNT_CODE_ACCESS` |
| `CALLDATALOAD` | `besu` (both), `erigon` (both), `geth` (R²), `nethermind` (both), `reth` (R²) | — |
| `EXP` | `nethermind` (both) | `COLD_ACCOUNT_CODE_ACCESS` |
| `GT` | `besu` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `JUMPDEST` | `besu` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `JUMPI` | `besu` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `KECCAK256` | `besu` (R²), `erigon` (R²), `geth` (R²), `nethermind` (both), `reth` (both) | `COLD_ACCOUNT_CODE_ACCESS` |
| `LT` | `besu` (R²) | `COLD_STORAGE_ACCESS` |
| `MSTORE` | `reth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
| `MSTORE8` | `erigon` (R²) | `COLD_ACCOUNT_CODE_ACCESS` |
| `PC` | `erigon` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `RETURNDATASIZE` | `besu` (R²), `nethermind` (R²) | — |
| `SELFBALANCE` | `besu` (R²) | — |
| `SUB` | `reth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `SWAP` | `nethermind` (R²) | — |
...
| --- | --- | --- | --- | --- |
| `test_sstore_bloated` | `SSTORE` | `target_coef` | — | `reth` (p-value) |
...
| Test | Target opcode | Coef | Combo | Failing clients |
| --- | --- | --- | --- | --- |
| `test_account_access` | `CALL` | `target_coef` | `param_account_mode=AccountMode.EXISTING_EOA` / `param_opcode=CALL` | `reth` (p-value) |
| `test_account_access` | `EXTCODECOPY` | `target_coef` | `param_account_mode=AccountMode.NON_EXISTING_ACCOUNT` / `param_opcode=EXTCODECOPY` | `besu` (R²) |
...
| Test | Target opcode | Coef | Combo | Failing clients |
| --- | --- | --- | --- | --- |
| `test_account_access` | `CALL` | `update` | `param_account_mode=AccountMode.NON_EXISTING_ACCOUNT` / `param_opcode=CALL` | `geth` (p-value) |
