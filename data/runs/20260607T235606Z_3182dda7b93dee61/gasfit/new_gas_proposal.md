...
_Generated 2026-06-08 08:35:22Z · fork `osaka` · anchor_rate 100 Mgas/s_

**Summary:** 9 parameters proposed — 8 increased, 1 decreased, 0 new, 0 unresolved · 4 warnings · 1 poor-fit selection
...
| --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | 2100 | 3040 | +940 | +45% |
| STORAGE_WRITE | 2800 | 57960 | +55160 | +1970% |
| COLD_ACCOUNT_NOCODE_ACCESS | 2600 | 4010 | +1410 | +54% |
| ACCOUNT_WRITE | 6700 | 28411 | +21711 | +324% |
| COLD_ACCOUNT_CODE_ACCESS | 2600 | 10123 | +7523 | +289% |
| WARM_ACCESS | 100 | 58 | -42 | -42% |
| REFUND_STORAGE_CLEAR | 4800 | 58560 | +53760 | +1120% |
| TX_ACCESS_LIST_STORAGE_KEY | 1900 | 3040 | +1140 | +60% |
| TX_ACCESS_LIST_ADDRESS | 2400 | 10123 | +7723 | +322% |
...
| --- | --- | --- | --- | --- | --- |
| COLD_STORAGE_ACCESS | geth | 3040 | nethermind | 2766 | 1.10× |
| STORAGE_WRITE | geth | 57960 | reth | 17093 | 3.39× |
| COLD_ACCOUNT_NOCODE_ACCESS | geth | 4010 | besu | 1620 | 2.48× |
| ACCOUNT_WRITE | erigon | 28411 | reth | 16317 | 1.74× |
| COLD_ACCOUNT_CODE_ACCESS | erigon | 10123 | geth | 4010 | 2.52× |
...
<details>
<summary><b>Priced glue opcodes with a poor fit</b> — 52 (glue_opcode, client) fits skipped</summary>
...
| `AND` | `erigon` (R²), `geth` (R²) | `COLD_ACCOUNT_CODE_ACCESS` |
...
| `EXP` | `erigon` (R²), `geth` (R²), `nethermind` (both) | `COLD_ACCOUNT_CODE_ACCESS` |
| `GAS` | `geth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_STORAGE_ACCESS`, `WARM_ACCESS` |
| `GT` | `besu` (R²), `geth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `ISZERO` | `erigon` (R²), `geth` (R²) | `COLD_ACCOUNT_CODE_ACCESS` |
| `JUMP` | `besu` (R²), `geth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS` |
| `JUMPDEST` | `besu` (R²), `geth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_ACCOUNT_NOCODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `JUMPI` | `besu` (R²), `geth` (R²) | `COLD_ACCOUNT_CODE_ACCESS`, `COLD_STORAGE_ACCESS` |
| `KECCAK256` | `besu` (R²), `erigon` (R²), `geth` (R²), `nethermind` (both), `reth` (both) | `COLD_ACCOUNT_CODE_ACCESS` |
| `LT` | `besu` (R²), `geth` (R²) | `COLD_STORAGE_ACCESS` |
...
| `MUL` | `besu` (R²), `geth` (R²) | `COLD_ACCOUNT_CODE_ACCESS` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `STORAGE_WRITE` | `geth` | `test_sstore_bloated` | `SSTORE` | `update` | 0.5796 | 0.001 | 0.2443 | R² |
...
| `test_sstore_bloated` | `SSTORE` | `target_coef` | `param_existing_slots=True` | `erigon` (p-value), `geth` (R²), `reth` (p-value) |
...
<details>
<summary><code>WARM_ACCESS</code> — 5 weak combos</summary>
